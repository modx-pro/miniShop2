...
$_lang['ms2_utilites_gallery'] = 'Gallery';
$_lang['ms2_utilites_gallery_done'] = 'Done';
$_lang['ms2_utilites_gallery_done_message'] = 'Updating image previews successfully completed.';
$_lang['ms2_utilites_gallery_err_noproducts'] = 'Catalog is empty';
$_lang['ms2_utilites_gallery_for_step'] = 'Process products in 1 step';
$_lang['ms2_utilites_gallery_information'] = 'Media source selected: <strong>{0}</strong> <a href="?a=source/update&id={1}" target="_blank"><i class="icon icon-cog"></i ></a><br>Total products: <strong>{2} pcs.</strong> <br> Images: <strong>{3} pcs.</strong>';
$_lang['ms2_utilites_gallery_intro'] = 'Updates all product images according to the specified parameters. <br>This operation is complex, so do not specify a large number for one iteration.';
$_lang['ms2_utilites_gallery_refresh'] = 'Update';
$_lang['ms2_utilites_gallery_updating'] = 'Preview update';
$_lang['ms2_utilites_params'] = 'Options';
