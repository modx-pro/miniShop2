...
$_lang['setting_ms2_vendor_parents'] = 'Ресурсы с созданными производителями';
$_lang['setting_ms2_vendor_parents_desc'] = 'Укажите id ресурсов через запятую, для ограничения выборки ресурсов в окне создания производителя';
...
$_lang['setting_ms2_product_thumbnail_default'] = 'Путь к превью по умолчанию';
$_lang['setting_ms2_product_thumbnail_default_desc'] = 'Здесь вы можете указать путь к превью товара, по умолчанию указан логотип miniShop2. Если оставить поле пустым, то превью товара будет скрыто, до тех пор, пока в галерею не будут загружены изображения товара.';
