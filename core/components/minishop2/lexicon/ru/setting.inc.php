...
$_lang['ms2_cart_product_key_fields'] = 'Список полей для ключа товара в корзине';
$_lang['ms2_cart_product_key_fields_desc'] = 'Список полей товара через запятую, на основании которых формируется ключ товара в корзине';
