...
$_lang['ms2_discount'] = 'Типы скидок';
$_lang['ms2_discount_intro'] = 'Укажите типы скидок для дисконтных карт. Например, "5%" или "2000".<br>
Здесь же вы можете привязать скидку к конкретному товару. Например, у вас есть товар "Дисконтная карта на сумму 5%". Создайте тип скидки "5%" и свяжите её с этим товаром.<br>
...
$_lang['ms2_discountcard'] = 'Дисконтные карты';
$_lang['ms2_discountcard_intro'] = 'Здесь, вы можете создавать дисконтные карты и связывать их с созданными раннее скидками.<br>
Так же можно устанавливать лимит пользования (0 - неограниченно).<br>
Дисконтные карты могут быть:<br>
 - общего пользования;
