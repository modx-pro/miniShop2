...
$_lang['setting_ms2_cart_percent_precision'] = 'Точность округления процентов';
$_lang['setting_ms2_cart_percent_precision_desc'] = 'число знаков после запятой (или до если здесь будет указано отрицательное значение) при округлении процента скидки';
$_lang['setting_ms2_product_key_parts'] = 'Части ключа товара в корзине';
$_lang['setting_ms2_product_key_parts_desc'] = 'допустимо использовать все поля товара и options целиком';
