...
$_lang['ms2_deliveries_intro'] = 'Магчымыя варыянты дастаўкі. Логіка разліках кошту дастаўкі ў залежнасці ад адлегласці і вагі рэалізуецца класам, які вы пакажа ў наладах.<br/>Калі вы не пакажаце свой клас, разлік будзе вырабляцца алгарытмам па-змаўчанні.';
...
$_lang['ms2_frontend_colors'] = 'Колер';
