{if !$.get['msorder']}
    <form data-ms-order="" class="ms2_form {!$order.cart_cost ? 'ms-hidden' : ''}" id="msOrder" method="post">
        <div class="row">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-end mb-5">
            ...
            <h3 class="mb-md-0 ml-md-2">
                <span data-ms-order-cart-cost>{$order.cart_cost ?: 0}</span> {'ms2_frontend_currency' | lexicon} +
                <span data-ms-order-delivery-cost>{$order.delivery_cost ?: 0}</span> {'ms2_frontend_currency' | lexicon} =
                <span data-ms-order-cost>{$order.cost ?: 0}</span> {'ms2_frontend_currency' | lexicon}
            </h3>
            <h3 class="mb-md-0 ml-md-2" data-ms-fields-wrap>
                Ваша скидка: <span data-ms-order-discount-cost>{$order.discount_cost ?: 0}</span> {'ms2_frontend_currency' | lexicon}
                (<span data-ms-order-discount-percent>{$order.discount_percent ?: 0}</span>%)
