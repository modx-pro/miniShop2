...
$_lang['ms2_payments'] = 'Методы оплаты';
...
$_lang['ms2_deliveries'] = 'Способы доставки';
$_lang['ms2_deliveries_intro'] = 'Возможные способы доставки. Логика рассчёта стоимости доставки в зависимости от расстояния и веса реализуется классом, который вы укажете в настройках.<br/>Если вы не укажете свой класс, рассчеты будут производиться алгоритмом по-умолчанию.';
