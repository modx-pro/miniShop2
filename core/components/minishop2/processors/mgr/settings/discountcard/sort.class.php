...
class msDiscountCardSortProcessor extends modObjectProcessor {
	public $objectType = 'msDiscountCardCard';

	// public function process() {
	// 	/* @var msDiscountCardCard $source */
	// 	$source = $this->modx->getObject($this->objectType, $this->getProperty('source'));
	// 	/* @var msDiscountCardCard $target */
...
return 'msDiscountCardSortProcessor';