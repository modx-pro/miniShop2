...
$_lang['ms2_prop_sortOptions'] = 'Specifies the sort order of option values. Passed as a string, e.g., "size:SORT_DESC:SORT_NUMERIC:100,color:SORT_ASC:SORT_STRING"';
