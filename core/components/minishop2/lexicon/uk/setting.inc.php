...
$_lang['setting_ms2_cart_context'] = 'Використовувати єдину кошик для всіх контекстів?';
$_lang['setting_ms2_cart_context_desc'] = 'Якщо включено, то використовується загальний кошик для всіх контекстів. Якщо вимкнено - то у кожного контексту використовується своя кошик.';
