...
$_lang['setting_ms2_cart_context_init'] = 'Единая корзина на все контексты?';
$_lang['setting_ms2_cart_context_init_desc'] = 'Если Да, корзина одна на все контексты. Если Нет - у каждого контекста своя корзина.';
