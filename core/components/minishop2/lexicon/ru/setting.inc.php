...
$_lang['setting_ms2_cart_context_init'] = 'Использовать единую корзину для всех контекстов?';
$_lang['setting_ms2_cart_context_init_desc'] = 'Если включено, то используется общая корзина для всех контекстов. Если выключено - то у каждого контекста используется своя корзина.';
