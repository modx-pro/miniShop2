var methods = {
	...
	,getAllProductFields: function(config) {
		var fields = {
			...
			,template: {xtype: 'modx-combo-template',editable: false,baseParams: {action: MODx.action['welcome'] == 'welcome' ? 'element/template/getlist' : 'getlist', combo: '1'},listeners: {select: {fn: this.templateWarning,scope: this}}}
