...
class msVendorSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param msVendor $source
     * @param msVendor $target
     *
     * @return array|string
     */
    public function sort(msVendor $source, msVendor $target)
    {
