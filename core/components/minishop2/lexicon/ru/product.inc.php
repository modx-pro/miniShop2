...
$_lang['ms2_product_createdby'] = 'Кто создал';
$_lang['ms2_product_createdon'] = 'Дата создания';
$_lang['ms2_product_editedby'] = 'Кто изменял';
...
$_lang['ms2_product_publishedon'] = 'Дата публикации';
