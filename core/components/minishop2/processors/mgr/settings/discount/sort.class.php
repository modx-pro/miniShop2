...
class msDiscountSortProcessor extends modObjectProcessor {
	public $objectType = 'msDiscount';

	// public function process() {
	// 	/* @var msDiscountCard $source */
	// 	$source = $this->modx->getObject($this->objectType, $this->getProperty('source'));
	// 	/* @var msDiscountCard $target */
...
return 'msDiscountSortProcessor';