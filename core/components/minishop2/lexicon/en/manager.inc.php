...
$_lang['ms2_utilities_gallery'] = 'Gallery';
$_lang['ms2_utilities_gallery_done'] = 'Done';
$_lang['ms2_utilities_gallery_done_message'] = 'Updating image previews successfully completed.';
$_lang['ms2_utilities_gallery_err_noproducts'] = 'Catalog is empty';
$_lang['ms2_utilities_gallery_for_step'] = 'Process products in 1 step';
...
$_lang['ms2_utilities_gallery_step_offset'] = 'Offset products';
...
$_lang['ms2_utilities_import_file_ns'] = 'Import file cannot be empty.';
$_lang['ms2_utilities_import_file_ext_err'] = 'Invalid file extension.<br> Only *.csv allowed';
$_lang['ms2_utilities_import_file_nf'] = 'File with location <strong>[[+path]]</strong> not found';
$_lang['ms2_utilities_import_fields_ns'] = 'The <strong>Import fields</strong> parameter was not set.';
$_lang['ms2_utilities_import_intro'] = 'Simple import of the product catalog. <br>When importing a large volume of goods, your site may stop responding.<br>We recommend running the utility in the background, for this you need to check the "Use scheduler" checkbox (requires the installed component <a href="https://modstore.pro /packages/utilities/scheduler" target="_blank">Scheduler</a>)';
$_lang['ms2_utilities_import_key_ns'] = 'The <strong>Unique field</strong> parameter was not set.';
$_lang['ms2_utilities_import_success'] = 'Import completed.<br>Total rows processed: <strong>[[+total]]</strong><br>Created: <strong>[[+created]]</strong><br>Updated: <strong>[[+updated]]</strong>';
$_lang['ms2_utilities_import_label_delimiter'] = 'Column separator in a file';
$_lang['ms2_utilities_import_label_fields'] = 'Import fields';
$_lang['ms2_utilities_import_label_file'] = 'Import file';
$_lang['ms2_utilities_import_label_file_empty'] = 'Select file';
$_lang['ms2_utilities_import_required_field'] = 'Required field missing <strong>[[+field]]</strong>';
$_lang['ms2_utilities_import_save_fields'] = 'Save fields settings';
$_lang['ms2_utilities_import_save_fields_title'] = 'Saved';
$_lang['ms2_utilities_import_save_fields_message'] = 'The list of fields for import is saved';
$_lang['ms2_utilities_import_skip_header'] = 'Skip the first header line';
$_lang['ms2_utilities_import_submit'] = 'Start Import';
$_lang['ms2_utilities_import_update_key'] = 'Unique field for update';
$_lang['ms2_utilities_import_update_products'] = 'Update products';
$_lang['ms2_utilities_import_use_scheduler'] = 'Use schedule';
$_lang['ms2_utilities_params'] = 'Settings ';
$_lang['ms2_utilities_scheduler_nf'] = 'Scheduler component not installed';
$_lang['ms2_utilities_scheduler_task_ce'] = 'Failed to create Scheduler task';
$_lang['ms2_utilities_scheduler_success'] = 'Scheduler task created';
